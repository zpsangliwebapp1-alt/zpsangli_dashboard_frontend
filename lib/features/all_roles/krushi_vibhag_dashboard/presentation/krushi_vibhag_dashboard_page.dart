  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (width >= Breakpoints.desktop) {
        return const KrushiVibhageDesktopDashboard();
      } else if (width >= Breakpoints.tablet) {
        return const KrushiVibhagTabletDashboard();
      } else {
        return const KrushiVibhagMobileDashboard();
      }
    });
  }
}
...
/////////////// DESKTOP LAYOUT ///////////////
class KrushiVibhageDesktopDashboard extends StatelessWidget {
  const KrushiVibhageDesktopDashboard({super.key});
...
/////////////// TABLET LAYOUT ///////////////
class KrushiVibhagTabletDashboard extends StatelessWidget {
  const KrushiVibhagTabletDashboard({super.key});
...
/////////////// MOBILE LAYOUT ///////////////
class KrushiVibhagMobileDashboard extends StatelessWidget {
  const KrushiVibhagMobileDashboard({super.key});
